...
export const 计算秒伤 = (params) => {
  ...
  const 木桩计算结果 = 伤害计算函数(心法, 计算用装备信息, 奇穴, 获取对应的循环名称, false, true)

  const 木桩属性收益 = 收益计算(心法, 计算用装备信息, 奇穴, 获取对应的循环名称, false)

  const 副本计算结果 = 伤害计算函数(心法, 计算用装备信息, 奇穴, 获取对应的循环名称, true, true)

  const 副本属性收益 = 收益计算(心法, 计算用装备信息, 奇穴, 获取对应的循环名称, true)
...
const 伤害计算函数 = (心法, 装备信息, 奇穴, 获取对应的循环名称, 增益启用, 是否郭氏计算) => {
