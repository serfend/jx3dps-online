...
import { 获取内功实际系数, 获取破招实际系数 } from '@/数据/数据工具/获取技能系数'
...
const 贯穿伤害系数 = 获取内功实际系数(215 * 0.7 * 1.15 * 0.9 * 0.9 * 0.9, {
  dot跳数: 4,
  dot间隔: 8,
})
...
const 技能基础数据: 技能基础数据模型[] = [
  {
    技能名称: '标鹄',
    技能伤害系数: 获取内功实际系数(512 * 1.15 * 0.9 * 0.95),
    基础伤害_基础值: 30,
    基础伤害_浮动值: 20,
    技能增益列表: 标鹄增益,
  },
  {
    技能名称: '劲风簇',
    技能伤害系数: 获取内功实际系数(175 * 0.9 * 0.9 * 0.95),
    基础伤害_基础值: 333,
    基础伤害_浮动值: 5,
    武器伤害系数: 1,
    技能增益列表: 劲风簇增益,
  ...
  {
    技能名称: '饮羽簇',
    技能伤害系数: 获取内功实际系数(552 * 0.9 * 0.9 * 0.95 * 0.9 * 0.95),
    基础伤害_基础值: 732,
    基础伤害_浮动值: 10,
    武器伤害系数: 2,
    技能增益列表: 饮羽簇增益,
