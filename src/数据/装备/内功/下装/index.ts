...
const 下装装备数据: 装备属性信息模型[] = [
  ...
  },
  {
    ...
    装备增益: [
      { 属性: 属性类型.体质, 值: 4249 },
      { 属性: 属性类型.根骨, 值: 824 },
      { 属性: 属性类型.内功基础攻击, 值: 1604 },
      { 属性: 属性类型.内功会心等级, 值: 4134 },
      { 属性: 属性类型.无双等级, 值: 3675 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.破招值 }, { 镶嵌类型: 属性类型.内功会心等级 }],
  },
  ...
  },
  {
    ...
    装备增益: [
      { 属性: 属性类型.体质, 值: 4141 },
      { 属性: 属性类型.根骨, 值: 803 },
      { 属性: 属性类型.内功基础攻击, 值: 1563 },
      { 属性: 属性类型.内功会心等级, 值: 4029 },
      { 属性: 属性类型.无双等级, 值: 3581 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.破招值 }, { 镶嵌类型: 属性类型.内功会心等级 }],
  },
  ...
  },
  {
    ...
    装备类型: 装备类型枚举.试炼精简,
    装备增益: [
      { 属性: 属性类型.内功基础攻击, 值: 3487 },
      { 属性: 属性类型.全会心等级, 值: 4477 },
      { 属性: 属性类型.无双等级, 值: 4701 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.全会心效果等级 }, { 镶嵌类型: 属性类型.无双等级 }],
  },
  ...
  },
  {
    ...
    装备增益: [
      { 属性: 属性类型.体质, 值: 4015 },
      { 属性: 属性类型.内功基础攻击, 值: 2798 },
      { 属性: 属性类型.全会心等级, 值: 2387 },
      { 属性: 属性类型.无双等级, 值: 6945 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.破招值 }, { 镶嵌类型: 属性类型.内功基础攻击 }],
  },
  {
    ...
    装备增益: [
      { 属性: 属性类型.体质, 值: 4015 },
      { 属性: 属性类型.内功基础攻击, 值: 3264 },
      { 属性: 属性类型.破招值, 值: 4124 },
      { 属性: 属性类型.内功破防等级, 值: 4124 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.全会心等级 }, { 镶嵌类型: 属性类型.内功基础攻击 }],
  },
  {
  ...
  },
  {
    ...
    装备增益: [
      { 属性: 属性类型.体质, 值: 3961 },
      { 属性: 属性类型.根骨, 值: 768 },
      { 属性: 属性类型.内功基础攻击, 值: 1495 },
      { 属性: 属性类型.内功会心等级, 值: 3854 },
      { 属性: 属性类型.破招值, 值: 3426 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.内功破防等级 }, { 镶嵌类型: 属性类型.破招值 }],
  },
  ...
  },
  {
    ...
    装备类型: 装备类型枚举.试炼精简,
    装备增益: [
      { 属性: 属性类型.内功基础攻击, 值: 3768 },
      { 属性: 属性类型.全会心等级, 值: 7118 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.全会心效果等级 }, { 镶嵌类型: 属性类型.全会心等级 }],
  },
  {
    ...
    装备类型: 装备类型枚举.试炼精简,
    装备增益: [
      { 属性: 属性类型.内功基础攻击, 值: 3214 },
      { 属性: 属性类型.内功破防等级, 值: 4126 },
      { 属性: 属性类型.无双等级, 值: 4126 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.破招值 }, { 镶嵌类型: 属性类型.内功基础攻击 }],
  },
  ...
  },
  {
    ...
    装备增益: [
      { 属性: 属性类型.体质, 值: 3781 },
      { 属性: 属性类型.元气, 值: 687 },
      { 属性: 属性类型.内功基础攻击, 值: 1098 },
      { 属性: 属性类型.内功破防等级, 值: 3679 },
      { 属性: 属性类型.全能等级, 值: 1635 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.内功破防等级 }, { 镶嵌类型: 属性类型.元气 }],
  },
  ...
  },
  {
    ...
    装备类型: 装备类型枚举.试炼精简,
    装备增益: [
      { 属性: 属性类型.内功基础攻击, 值: 3123 },
      { 属性: 属性类型.全会心等级, 值: 4010 },
      { 属性: 属性类型.无双等级, 值: 4010 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.全会心效果等级 }, { 镶嵌类型: 属性类型.无双等级 }],
  },
  ...
  },
  {
    ...
    装备类型: 装备类型枚举.试炼精简,
    装备增益: [
      { 属性: 属性类型.内功基础攻击, 值: 3555 },
      { 属性: 属性类型.内功破防等级, 值: 6715 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.破招值 }, { 镶嵌类型: 属性类型.内功基础攻击 }],
  },
  {
  ...
  },
  {
    ...
    装备增益: [
      { 属性: 属性类型.体质, 值: 3601 },
      { 属性: 属性类型.根骨, 值: 698 },
      { 属性: 属性类型.内功基础攻击, 值: 1359 },
      { 属性: 属性类型.内功破防等级, 值: 3504 },
      { 属性: 属性类型.破招值, 值: 3114 },
    ],
    镶嵌孔数组: [{ 镶嵌类型: 属性类型.内功破防等级 }, { 镶嵌类型: 属性类型.破招值 }],
  },
