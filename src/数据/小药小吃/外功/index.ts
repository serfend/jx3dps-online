...
import { 小吃类型枚举, 小药小吃数据类型 } from '../interface'
...
const 外功小药小吃数据: 小药小吃数据类型[] = [
  ...
  },
  {
    ...
    小吃部位: 小吃类型枚举.药品增强,
    小吃品级: '蓝',
    增益集合: [{ 属性: 属性类型.外功基础破防等级, 值: 1096 }],
  },
  {
    小吃名称: '断浪·上品破秽散（破防）',
    小吃部位: 小吃类型枚举.药品增强,
    小吃品级: '紫',
    增益集合: [{ 属性: 属性类型.外功基础破防等级, 值: 2192 }],
  },
  {
    小吃名称: '断浪·中品玉璃散（会心）',
    小吃部位: 小吃类型枚举.药品增强,
  ...
  },
  {
    ...
    小吃部位: 小吃类型枚举.食品增强,
    小吃品级: '蓝',
    增益集合: [{ 属性: 属性类型.外功基础破防等级, 值: 851 }],
  },
  {
    小吃名称: '断浪·红烧排骨（破防）',
    小吃部位: 小吃类型枚举.食品增强,
    小吃品级: '紫',
    增益集合: [{ 属性: 属性类型.外功基础破防等级, 值: 1705 }],
  },
  {
    小吃名称: '断浪·鱼香肉丝（会心）',
    小吃部位: 小吃类型枚举.食品增强,
  ...
  },
  {
    ...
    小吃部位: 小吃类型枚举.家园菜品,
    小吃品级: '蓝',
    增益集合: [{ 属性: 属性类型.外功基础破防等级, 值: 716 }],
  },
  {
    小吃名称: '断浪·清蒸鲈鱼（外破）',
    小吃部位: 小吃类型枚举.家园菜品,
    小吃品级: '紫',
    增益集合: [{ 属性: 属性类型.外功基础破防等级, 值: 1074 }],
  },
  {
    小吃名称: '炸鱼干（会心）',
    小吃部位: 小吃类型枚举.家园菜品,
