...
const 通用团队增益数据: 团队增益数据类型[] = [
  ...
  },
  {
    ...
    层数: 1,
    覆盖率: 66,
    增益图片: 'https://icon.jx3box.com/icon/1518.png',
    增益描述: '造成伤害提高【6%】',
    增益来源: '离经·悟',
    团队增益类型: '治疗Buff增益',
    覆盖率支持手动录入: true,
  ...
  },
  {
    ...
    层数选项数组: 按数字生成数组(3),
    覆盖率支持手动录入: true,
    // 这里实际是 11 21 31 偷懒先这么写了
    增益集合: [{ 属性: 属性类型.郭氏额外无双, 值: 11 }],
  },
  {
    增益名称: '弘法·悟',
    增益心法端: '无界',
  ...
  },
  {
    ...
    增益描述:
      '“大狮子吼”施展后，自身每【3060】点基础体质使团队成员气血上限提高【4500】点，最多24层。持续15秒。',
    增益来源: '洗髓经_奇穴',
    团队增益类型: '坦克Buff增益',
    层数选项数组: 按数字生成数组(24),
    增益集合: [{ 属性: 属性类型.额外气血上限, 值: 4500 }],
  },
  {
    增益名称: '瘦肉粽',
    层数: 1,
