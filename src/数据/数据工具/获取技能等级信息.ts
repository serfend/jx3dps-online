...
const 获取等级属性中部分属性的等级转换 = (技能信息: 技能等级数据类型, 技能等级: number) => {
  ...
  if (
    Array.isArray(技能信息?.基础伤害_基础值) ||
    (typeof 技能信息?.基础伤害_基础值 === 'object' && 技能信息?.基础伤害_基础值 !== null)
  ) {
    基础伤害_基础值 = 技能信息?.基础伤害_基础值?.[技能等级 - 1]
  }
  if (
    Array.isArray(技能信息?.基础伤害_浮动值) ||
    (typeof 技能信息?.基础伤害_基础值 === 'object' && 技能信息?.基础伤害_基础值 !== null)
  ) {
  ...
  if (技能信息?.技能名称 === '列宿游') {
    console.log('技能信息', 技能信息)
    console.log('基础伤害_基础值', 基础伤害_基础值)
    console.log('基础伤害_浮动值', 基础伤害_浮动值)
  }
